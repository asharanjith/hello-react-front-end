...
[Click here](https://github.com/asharanjith/hello-rails-back-end)to see the backend Repository built with Rails.
...
- **Create a front end app using React and connect it to a backend setup using Rails**
...
- `git clone https://github.com/asharanjith/hello-rails-front-end.git`
